                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <p>Register as an employes to apply for job listings.</p>
                                <a href="employees.php" class="btn btn-primary">Register as an Employee</a>
                            </div>
                        </div>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <a href="employeeJobs.php" class="btn btn-primary">View Job Listings</a>
                            </div>
                        </div>
                    </div>
                </div>
