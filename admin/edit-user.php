...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if (!empty($_POST['new_password'])) {
            ...
            $password_sql = "UPDATE users SET password = (:new_password) WHERE id = (:idedit)";
            $password_query = $dbh->prepare($password_sql);
            $password_query->bindParam(':new_password', $new_password, PDO::PARAM_STR);
            $password_query->bindParam(':idedit', $idedit, PDO::PARAM_STR);
