                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo isset($employee['name']) ? htmlentities($employee['name']) : ''; ?></td>
                                                    <td><?php echo isset($employee['email']) ? htmlentities($employee['email']) : ''; ?></td>
                                                    <td><?php echo isset($employee['role']) ? htmlentities($employee['role']) : ''; ?></td>
                                                    <td>
